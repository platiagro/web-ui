...
const HIDE_PRE_IMPLANTATION_MODAL = 'HIDE_PRE_IMPLANTATION_MODAL';
const SHOW_PRE_IMPLANTATION_MODAL = 'SHOW_PRE_IMPLANTATION_MODAL';
...
export default {
  ...
  // PRE IMPLANTATION MODAL
  HIDE_PRE_IMPLANTATION_MODAL,
  SHOW_PRE_IMPLANTATION_MODAL,
